...
import { Form, ButtonGroup, Button, Alert, Row, Col } from "react-bootstrap";
import { Auth, Logger } from "aws-amplify";

const logger = new Logger("JConfirmSignUp");

export default class MConfirmSignUp extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <Form style={style} preventDefault>
          ...
          {message && (
            <Alert success mt="3" text="left" style={style.alert}>
              {message}
            </Alert>
          )}
          {error && (
